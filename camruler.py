...
#-------------------------------
# konversi (pixels to satuan ukur)
#-------------------------------

# satuan jarak
unit_suffix = 'mm'

# kalibrasi setiap N pixel
pixel_base = 10

# max area pandang dari pusat ke tepi terjauh
# diukur dalam satuan unit_suffix 
cal_range = 90

# initial calibration values table {pixels:scale}
# berdasarkan frame size dan cal_range
cal = dict([(x,cal_range/dm) for x in range(0,int(dm)+1,pixel_base)])

# nilai pengulangan kalibrasi dalam main loop
cal_base = 5
cal_last = None
